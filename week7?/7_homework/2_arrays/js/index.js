$(function(){
    ...
    $('#showArrays').click(function(){
        ...
        //Your answer: weekdays = 5, weekends = 2
        ...
        //Can you remove a day from weekdays? delete weekdays[]; or weekdays.pop();

        //Can you add "Friday" to the weekends array? weekends.push("Friday");

        //With 1 line of code can you convert the weekends array to read: "Friday","Saturday","Sunday"? weekends.splice(0, 0, "Friday");
